...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { duedate: @auction.duedate, itemId: @auction.itemId, price: @auction.price, state: @auction.state } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { duedate: @auction.duedate, itemId: @auction.itemId, price: @auction.price, state: @auction.state } }
